...
public class ViewJoinGroups extends AppCompatActivity {
    ...
    private JoinGroupAdopter mAdapter;
    Grouplist group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Join Groups");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        ProgressDialog progressDialog;
        progressDialog = new ProgressDialog(ViewJoinGroups.this);
        progressDialog.setMessage("please wait...");
        progressDialog.show();
        String Url= StaticData.servername+"ViewJoinedGroups/"+getRememberusername();
        Url=Url.replace(" ","%20");
            ...
            public void onResponse(String s) {
                ...
                }else if (check.equals("2")&& !json.contains("Admin\":null"))
                {
                    ...
                    if (dataList.size() == 0) {
                        ...
                        mAdapter = new JoinGroupAdopter(dataList, getApplicationContext(),ViewJoinGroups.this);
