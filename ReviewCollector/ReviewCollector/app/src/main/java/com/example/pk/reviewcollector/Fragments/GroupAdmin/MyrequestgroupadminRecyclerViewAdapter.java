...
import com.example.pk.reviewcollector.Fragments.requestgroupadminFragment.OnListFragmentInteractionListener;
...
public class MyrequestgroupadminRecyclerViewAdapter extends RecyclerView.Adapter<MyrequestgroupadminRecyclerViewAdapter.MyViewHolder> {
    ...
    public MyrequestgroupadminRecyclerViewAdapter(List<UserSearch> moviesList, Context context, Activity a, String groupnamep) {
