...
public class MyuserlistgroupadminRecyclerViewAdapter extends RecyclerView.Adapter<MyuserlistgroupadminRecyclerViewAdapter.MyViewHolder> {
    ...
    String Groupname;
    public MyuserlistgroupadminRecyclerViewAdapter(List<UserSearch> moviesList, Context context, Activity a,String groupnamep) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.groupuserlist, parent, false);
...
//        byte[] decodedString = userSearch.getBase64Imag();
...
//        holder.profile.setImageBitmap(decodedByte);
        ...
        holder.remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String Url = StaticData.servername + "RemoveJoinedUsers/"+ userSearch.getUsername();
                Url = Url.replace(" ", "%20");
                ActionPerforme(act, Url);
                Log.d("", "JoinGroup" + Url);
                holder.remove.setText("Removed");

                Url = StaticData.servername + "CreateNotification/" + getRememberusertype() + " Remove you From Group " + Groupname + " /" + "No Flag/" + userSearch.getUsername();
                Url = Url.replace(" ", "%20");
