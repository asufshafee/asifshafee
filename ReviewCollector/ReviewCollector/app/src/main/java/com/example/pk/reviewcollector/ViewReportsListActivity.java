...
public class ViewReportsListActivity extends AppCompatActivity {
    ...
    private ViewReportListAdopter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reports_list);
        ...
        progressDialog = new ProgressDialog(ViewReportsListActivity.this);
            ...
            public void onResponse(String s) {
                ...
                }else if (check.equals("2"))
                {
                    ...
                    if (dataList.size() == 0) {
                        ...
                        mAdapter = new ViewReportListAdopter(dataList,ViewReportsListActivity.this,getIntent().getExtras().getString("gid"));
